...
<body>
  <div style="background:#F4E2D8; margin:0; height:100vh; display:flex; justify-content:center; align-items:center; flex-direction:column;">
    ...
    <a class="btn btn-primary" href="mockup.php">SEE MOCK UP <i class="bi bi-arrow-right"></i></a>
